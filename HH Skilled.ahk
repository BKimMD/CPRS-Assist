...
Loop{
	...
	if InStr(ConsultTxt, "To Service:            COMMUNITY CARE-GEC SKILLED COMMUNITY HOME CARE")
		break
...
;	msgbox % ConsultTxt
	...
	send {down 78}{enter}
	WinWaitActive, Service Prerequisites - COMMUNITY CARE-GEC SKILLED COMMUNITY HOME CARE ahk_class TfrmPrerequisites
